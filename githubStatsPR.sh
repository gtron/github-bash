...
function listPRsWithStats {
   ...
   github.sh pulls list $owner $repo closed  | jsonv number,user.login,head.label,state,created_at,closed_at,merged_at,head.repo.name,comments,review_comments,commits,additions,deletions,changed_files | tr , "\t"
